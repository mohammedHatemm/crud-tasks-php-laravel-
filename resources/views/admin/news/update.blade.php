                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('news.update', $news) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $news->name)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="flex items-center">
                                    <input id="category-{{ $category->id }}" name="categories[]" type="checkbox" value="{{ $category->id }}" class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" {{ in_array($category->id, old('categories', $selectedCategories)) ? 'checked' : '' }}>
