            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="{{ route('news.home') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline category-filter {{ !request('category') ? 'font-bold active-filter' : '' }}">
                                    جميع الأخبار
                                </a>
                            </li>
                            @foreach ($categories as $cat)
                            <li>
                                <a href="{{ route('news.home', ['category' => $cat->id]) }}" data-category-id="{{ $cat->id }}" class="text-indigo-600 dark:text-indigo-400 hover:underline category-filter {{ request('category') == $cat->id ? 'font-bold active-filter' : '' }}">
                                    {{ $cat->name }}
                                </a>
                                ...
                                <ul class="mr-4 mt-2 space-y-1">
                                    ...
                                    <li>
                                        <a href="{{ route('news.home', ['category' => $child->id]) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline {{ request('category') == $child->id ? 'font-bold' : '' }}">
                                            {{ $child->name }}
                                        </a>
                                    </li>
                                    @endforeach
